...
function parseRecord(record: unknown): Listing | null {
  ...
  return {
    ...
    businessPhoto: extractAttachmentUrl(pickField(fields, "Photo", "Business Photo")),
    ownerHeadshot: extractAttachmentUrl(pickField(fields, "Headshot", "Owner Headshot", "Headshot Photo", "Profile Photo")),
